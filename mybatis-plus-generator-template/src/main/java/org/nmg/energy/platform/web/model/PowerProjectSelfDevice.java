...
@TableName("T_POWER_PROJECT_SELF_DEVICE")
@ApiModel(value="PowerProjectSelfDevice对象", description="自备电厂设备信息")
public class PowerProjectSelfDevice implements Serializable {
